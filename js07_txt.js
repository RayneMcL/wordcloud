...
document.getElementById("getFile").onchange = function() {
      ...
      // alert the user to select the text file
      catch(err) {
            window.alert(err);
      }
      ...
      function wordCloud(sourceText) {
            ...
            // leave only the alphabet characters and whitespace in the text
            ...
            //create a 2d array in which each item is an array containing a word and its duplication count
            ...
            for (let i = 0; i < unique.length; i++) {
                  ...
                  words.style.fontSize = unique [i] [1] /maxCount + "em";
